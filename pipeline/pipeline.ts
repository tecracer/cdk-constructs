...
export class PipelineStack extends cdk.Stack {
  constructor(parent : cdk.App, id : string, props : cdk.StackProps = { }) {
    ...
    pipeline.publishToNpm({
      npmTokenSecret: { secretArn: 'arn:aws:secretsmanager:eu-west-1:todo:secret:todo' },
    });
  }
}
...
new PipelineStack(app, 'trc-cdkconstructs-pipeline', {
  env: { region: 'eu-central-1', account: 'todo' },
});
